...
export default function Conversation({ contact, messages = [], locale = 'en', loading = false, onBack, onCall, callDisabled, onImageClick, renderAudio, composer }) {
  ...
  return (
    <section className="conversation">
      <ConversationHeader contact={contact} locale={locale} onBack={onBack} onCall={onCall} callDisabled={callDisabled} />
      <div
        ref={scrollRef}
